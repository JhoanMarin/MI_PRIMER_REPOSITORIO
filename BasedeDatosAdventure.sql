...
/****** Object:  Database [AdventureWorks2014]    Script Date: 17/08/2023 4:11:51 p. m. ******/
CREATE DATABASE [AdventureWorks2014]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'AdventureWorks2014_Data', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.QVBITEST\MSSQL\DATA\AdventureWorks2014_Data.mdf' , SIZE = 210176KB , MAXSIZE = UNLIMITED, FILEGROWTH = 16384KB )
 LOG ON 
( NAME = N'AdventureWorks2014_Log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.QVBITEST\MSSQL\DATA\AdventureWorks2014_Log.ldf' , SIZE = 18432KB , MAXSIZE = 2048GB , FILEGROWTH = 16384KB )
...
ALTER DATABASE [AdventureWorks2014] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
